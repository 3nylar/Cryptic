...
**Contents:** [Modular arithmetic](#1-modular-arithmetic) · [Caesar](#2-the-caesar-cipher) · [Vigenère](#3-the-vigenère-cipher) · [Frequency analysis](#4-frequency-analysis) · [Chi-squared](#5-the-chi-squared-test) · [Index of coincidence](#6-the-index-of-coincidence) · [Kasiski](#7-the-kasiski-examination) · [The attack](#8-the-full-vigenère-attack) · [Bigrams](#9-the-bigram-model) · [Reading](#further-reading)
...
Described by **Al-Kindi** in Baghdad in the 9th century — the first recorded cryptanalytic technique in history. It still works on anything that preserves letter identity.
